  ...
  <main class="flex-1 items-center bg-linear-to-t from-[#2B35BD] to-[#22C1C3]">
    ...
    <div class="mx-auto w-full max-w-md px-4 py-16">
      <div class="rounded-3xl p-6 text-center">
        <h1 class="mb-6 text-6xl font-bold text-white">Get Started</h1>
        <p class="mb-6 text-white/90">Create a free account today</p>
      </div>
      ...
      <div class="rounded-2xl bg-white/10 p-8 backdrop-blur-sm">
        <form @submit.prevent="onSubmit" class="space-y-6">
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-white/60">Password must be at least 8 characters</p>
          </div>
        ...
        <p class="mt-6 text-center text-sm text-white/80">
          ...
          <RouterLink to="/login" class="font-semibold text-white underline hover:text-white/80">
            Sign in here
          </RouterLink>
        </p>
      </div>
